defmodule MolabhbotWeb.RoleControllerTest do
  use MolabhbotWeb.ConnCase

  alias Molabhbot.Accounts

  @create_attrs %{description: "some description", role: "some role"}
  @update_attrs %{description: "some updated description", role: "some updated role"}
  @invalid_attrs %{description: nil, role: nil}
